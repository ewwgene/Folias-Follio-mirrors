...
Алгоритм собран в _`HOUDINI`_ с помощью _VOP_ и _VEX_ инструментов и с использованием _UV_-разветки текстуры и [_Slit-Scan_ алгоритма](https://ewwgene.github.io/Slit-Scan_01-ALGORITHM). За референс взяты элементы декора архитектуры, скульптуры и дизайна. На выходе из алгоритма создаются облака точек, которые дальше обрабатываются в _`MESHLAB`_ и в виде замкнутых _*.stl_ импортируются в _`RHINOCEROS_3D`_ для их раскладки и моделирования несущей рамы.<br> Отдельные элементы выфрезерованны из гипсовых блоков на станке с ЧПУ _**`CNC_MILLING`**_ и закреплены на массивной раме из дерева размером _1500mm&times;1000mm_.
